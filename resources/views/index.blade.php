                ...
                <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                    <div class="carousel-inner w-100" role="listbox">
                        <div class="carousel-item row no-gutters active">
                            <div class="col-3 col-md-3 float-left"><img alt="exception" title="exception" class="img-fluid img-carrossel" src="image/logo1.jpg"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="dior" title="dior" class="img-fluid img-carrossel" src="image/logo2.jpg"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="marisa" title="marisa" class="img-fluid img-carrossel" src="image/logo3.png"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="monarch" title="monarch" class="img-fluid img-carrossel" src="image/logo4.jpeg"></div>
                        </div>
                        <div class="carousel-item row no-gutters">
                            <div class="col-3 col-md-3 float-left"><img alt="calvin klein" title="calvin klein" class="img-fluid img-carrossel" src="image/logo5.png"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="oasis" title="oasis" class="img-fluid img-carrossel" src="image/logo6.png"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="cartier" title="cartier" class="img-fluid img-carrossel" src="image/logo7.png"></div>
                            <div class="col-3 col-md-3 float-left"><img alt="fashion nova" title="fashion nova" class="img-fluid img-carrossel" src="image/logo8.png"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="servicos">
                ...
                <div>
                    <div class="row align-items-center">
                        ...
                        <img class="img-fluid p-0 d-block imagem-services" alt="Encontre os influenciadores para sua marca" title="Influenciadora1" src="image/influencer9.png" alt="">
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <img class="img-fluid p-0 d-block imagem-services" alt="Personalize sua campanha" title="Influenciadora2" src="image/influencer10.png" alt="">
                        </div>
                        <div class="col-md-8 servicos-texto">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-4 d-flex justify-content-center">
                        <img class="img-fluid p-0 d-block imagem-services" alt="Acompanhe os resultados na nossa plataforma" title="Influenciadora3" src="image/influencer10.png" alt="">
                        </div>
                        <div class="col-md-8 servicos-texto">
            ...
            <section class="container">
                ...
                <div class="row text-center text-lg-left ">
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="polaroid">
                            <img alt="Juliana Ferrari Reach Me Out" title="Juliana Ferrari" src="image/influencer1.png" class=" img-fluid rounded">
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="polaroid">
                            <img alt="Barbara Ferreira Reach Me Out" title="Barbara Ferreira" src="image/influencer2.png" class="img-fluid rounded" />
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="polaroid">
                            <img alt="Paula Estevan Reach Me Out" title="Paula Estevan" src="image/influencer3.png" class="img-fluid rounded" />
                            <h3>Paula Estevan</h3>
                        <div class="d-flex flex-column align-items-center">
                            <img class="insta" src="image/insta.png" alt="">
                            <p>@Paula_Estevan</p>
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="polaroid">
                            <img alt="Pietra Stefani Reach Me Out" title="Pietra Stefani" src="image/influencer4.jpg" class="img-fluid rounded" />
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="influencers-desktop polaroid">
                            <img alt="Marcelo Silva Reach Me Out" title="Marcelo Silva" src="image/influencer5.png" class="img-fluid rounded" />
                            <h3>Marcelo Silva</h3>
                        <div class="d-flex flex-column align-items-center">
                            <img class="insta" src="image/insta.png" alt="">
                            <p>@Marcelo_Silva</p>
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="influencers-desktop polaroid">
                            <img alt="Ana Maggiori Reach Me Out" title="Ana Maggiori" src="image/influencer6.jpg" class="img-fluid rounded" />
                            <h3>Ana Maggiori</h3>
                        <div class="d-flex flex-column align-items-center">
                            <img class="insta" src="image/insta.png" alt="">
                            <p>@Ana_Maggiori</p>
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="influencers-desktop polaroid">
                            <img alt="Amanda Zanon Reach Me Out" title="Amanda Zanon" src="image/influencer7.jpg" class="img-fluid rounded" />
                            <h3>Amanda Zanon</h3>
                        <div class="d-flex flex-column align-items-center">
                            <img class="insta" src="image/insta.png" alt="">
                            <p>@Amanda_Zanon</p>
                    ...
                    <figure class="col-lg-3 col-md-4 col-12 d-flex justify-content-center">
                        <div class="influencers-desktop polaroid">
                            <img alt="Aline Cury Reach Me Out" title="Aline Cury" src="image/influencer8.jpg" class="img-fluid rounded" />
                            <h3>Aline Cury</h3>
                        <div class="d-flex flex-column align-items-center">
                            <img class="insta" src="image/insta.png" alt="">
                            <p>@Aline_Cury</p>
